export type KOCServerTunables =
  ...
  | 'droid_charge_duration_ms_max_hi_skill'
  | 'droid_charge_duration_ms_max_lo_skill'
  | 'droid_charge_duration_ms_min_hi_skill'
  | 'droid_charge_duration_ms_min_lo_skill'
  | 'droid_defend_chance_hi_skill'
  | 'droid_defend_chance_lo_skill'
  | 'droid_desired_distance_hi_skill'
  | 'droid_desired_distance_lo_skill'
  | 'droid_fake_throw_chance_percentage_hi_skill'
  | 'droid_fake_throw_chance_percentage_lo_skill'
  | 'droid_fake_throw_skill_threshold'
  | 'droid_gang_up_skill_threshold'
  | 'droid_hi_skill'
  | 'droid_human_vs_human_skill_offset'
  | 'droid_lo_skill'
  | 'droid_mash_time_ms_max_hi_skill'
  | 'droid_mash_time_ms_max_lo_skill'
  | 'droid_mash_time_ms_min_hi_skill'
  | 'droid_mash_time_ms_min_lo_skill'
  | 'droid_offensive_dodge_tackle_ideal_delay_ms_hi_skill'
  | 'droid_offensive_dodge_tackle_ideal_delay_ms_lo_skill'
  | 'droid_offensive_dodge_tackle_skill_threshold'
  | 'droid_perfect_chance_hi_skill'
  | 'droid_perfect_chance_lo_skill'
  | 'droid_reaction_time_ms_hi_skill'
  | 'droid_reaction_time_ms_lo_skill'
  | 'droid_skill_offset'
  | 'droid_skill_ratchet_step'
  | 'droid_throw_delay_ms_max_hi_skill'
  | 'droid_throw_delay_ms_max_lo_skill'
  | 'droid_throw_delay_ms_min_hi_skill'
  | 'droid_throw_delay_ms_min_lo_skill'
  | 'droid_throw_visibilty_cone_half_angle_hi_skill'
  | 'droid_throw_visibilty_cone_half_angle_lo_skill'
